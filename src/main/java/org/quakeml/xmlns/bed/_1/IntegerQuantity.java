...
/**
 * <p>Java class for IntegerQuantity complex type</p>.
 * 
...
public class IntegerQuantity {
    ...
    protected List<JAXBElement<? extends Comparable>> valueOrUncertaintyOrLowerUncertainty;
     ...
     * This is why there is not a <CODE>set</CODE> method for the valueOrUncertaintyOrLowerUncertainty property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the valueOrUncertaintyOrLowerUncertainty property.
     */
    public List<JAXBElement<? extends Comparable>> getValueOrUncertaintyOrLowerUncertainty() {
        if (valueOrUncertaintyOrLowerUncertainty == null) {
            valueOrUncertaintyOrLowerUncertainty = new ArrayList<>();
        }
