...
/**
 * <p>Java class for StationMagnitude complex type</p>.
 * 
...
public class StationMagnitude {
     ...
     * This is why there is not a <CODE>set</CODE> method for the commentOrOriginIDOrMag property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the commentOrOriginIDOrMag property.
     */
    public List<JAXBElement<?>> getCommentOrOriginIDOrMag() {
        if (commentOrOriginIDOrMag == null) {
            commentOrOriginIDOrMag = new ArrayList<>();
        }
