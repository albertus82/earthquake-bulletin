...
/**
 * <p>Java class for Magnitude complex type</p>.
 * 
...
public class Magnitude {
     ...
     * This is why there is not a <CODE>set</CODE> method for the commentOrStationMagnitudeContributionOrMag property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the commentOrStationMagnitudeContributionOrMag property.
     */
    public List<JAXBElement<?>> getCommentOrStationMagnitudeContributionOrMag() {
        if (commentOrStationMagnitudeContributionOrMag == null) {
            commentOrStationMagnitudeContributionOrMag = new ArrayList<>();
        }
